using System.Collections; using System.Collections.Generic; using UnityEditor; using UnityEngine; using UnityEngine.EventSystems; using UnityEngine.SceneManagement;  public class pausemenu : MonoBehaviour { public static bool isPaused = false; public GameObject pauseMenuUI; private float prev_timeScale = 1f; private int length;    // Start is called before the first frame update void Start() {     pauseMenuUI.SetActive(false);     length = dwarf_spawner.dwarf_teams.Length;
